...
def add_noise(img_tensor, gtboxes_and_label):
    h, w = tf.shape(img_tensor)[0], tf.shape(img_tensor)[1]
    img_tensor = tf.add(img_tensor,tf.truncated_normal(tf.shape(img_tensor), stddev = 0.1))
    return img_tensor, gtboxes_and_label
...
if __name__=='__main__':
    ...
    img, gtboxes_and_label = random_flip_up_down(img_tensor=img,
                                                                  gtboxes_and_label=gtboxes_and_label)
    img, gtboxes_and_label = random_add_noise(img_tensor=img, gtboxes_and_label=gtboxes_and_label)
    img, gtboxes_and_label = random_rotate_90(img_tensor=img, gtboxes_and_label=gtboxes_and_label)
    img, gtboxes_and_label = random_rotate_180(img_tensor=img, gtboxes_and_label=gtboxes_and_label)
    img, gtboxes_and_label = random_rotate_270(img_tensor=img, gtboxes_and_label=gtboxes_and_label)
    img, gtboxes_and_label = random_adjust(img_tensor=img, gtboxes_and_label=gtboxes_and_label)